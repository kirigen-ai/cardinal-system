...
#include "VideoPipeline.generated.h"

USTRUCT(BlueprintType, META = (DisplayName = "Video Pipeline Config"))
struct FVideoPipelineConfig
{
	GENERATED_BODY()
	
};

UCLASS(Blueprintable, BlueprintType, META = (DisplayName = "Video Pipeline"))
class CARDINALSYSTEM_API UVideoPipeline : public UAgentPipeline
{
	GENERATED_BODY()

	public:
		UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cardinal System|Video Pipeline")
		FVideoPipelineConfig Config;	
};